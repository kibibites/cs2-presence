...
| platform    | link                                                                                                                                                                                          |
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **windows** | [latest](https://github.com/kibibites/cs2-presence/releases/download/1.1.2/cs2-presence.exe.xz) \| [nightly](https://nightly.link/kibibites/cs2-presence/workflows/deno/mistress/windows.zip) |
| **linux**   | [latest](https://github.com/kibibites/cs2-presence/releases/download/1.1.2/cs2-presence.xz) \| [nightly](https://nightly.link/kibibites/cs2-presence/workflows/deno/mistress/linux.zip)       |
